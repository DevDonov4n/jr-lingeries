      ...
      <section className={styles.grid}>
          ...
          {editing ? (
            <form className={styles.form} onSubmit={handleProfileSubmit}>
              ...
              <div className={styles.formRow}>
                ...
                <label>
                  Estado
                  <input name="state" maxLength={2} defaultValue={user.state} />
                </label>
              </div>
              <button
            ...
            <div className={styles.details}>
              ...
              <div>
                <span>Bairro</span>
                <strong>{user.neighborhood || "Não informado"}</strong>
              </div>
              <div>
              ...
              <div>
                <span>CEP</span>
                <strong>{user.zipCode || "Não informado"}</strong>
              </div>
            </div>
          )}
        </article>
        ...
        <aside className={styles.sideColumn}>
          ...
          <a className={styles.actionCard} href="/cliente/sugestoes">
            ...
            <span>
              Conte para a JR Lingeries o que você gostaria de encontrar.
            </span>
          </a>
          <div className={styles.passwordCard}>
            ...
            <h2>Alterar senha</h2>
            <p>
              Troque sua senha usando a senha atual para confirmar sua
              identidade.
            </p>
            {passwordMessage && (
              <p
