    ...
    <main className={styles.page}>
      <header className={styles.header}>
        <div>
          ...
          <h1>Sugira uma peça 💗</h1>
          <p>Conte para a JR Lingeries qual peça ou pedido você gostaria de encontrar.</p>
        </div>
      ...
      <section className={styles.card}>
        <form className={styles.form} onSubmit={handleSubmit}>
          <label>
            Qual peça você gostaria?
            <input name="name" placeholder="Ex.: Conjunto de renda preto" maxLength={150} required />
          </label>
          ...
          <div className={styles.formRow}>
            ...
            <label>
              Cor
              <input name="color" placeholder="Ex.: Preto" maxLength={50} />
            </label>
          </div>

          <label>
            Tamanho
            <input name="size" placeholder="Ex.: M" maxLength={30} />
          </label>

          <label>
            Conte mais sobre seu pedido
            <textarea name="description" placeholder="Descreva detalhes, modelo, tecido, estilo ou qualquer preferência." maxLength={5000} rows={6} />
          </label>
