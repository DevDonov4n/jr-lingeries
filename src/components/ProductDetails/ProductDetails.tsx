...
function colorValue(color: string) { const normalized = color.toLocaleLowerCase("pt-BR").trim(); return colorMap[normalized] ?? (/^#([0-9a-f]{3}|[0-9a-f]{6})$/i.test(normalized) ? normalized : "#d2a58a"); }
